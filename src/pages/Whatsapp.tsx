...
const useWhatsAppParams = ({ autoRedirect = true, redirectDelay = 3000 } = {}) => {
  ...
  const buildWhatsAppUrl = (phone: string, messageType: string) => {
    ...
    switch (messageType) {
      case 'faleconosco':
        message = "Oi! estava no seu site, gostaria de saber mais!😁";
        break;
      case 'falenowhatsapp':
        message = "Oi! estava no seu site, gostaria de conhecer mais!😁";
        break;
      case 'solicitarorcamento':
        message = "Oi! estava no seu site, de solicitar um orçamento!😁";
        break;
      default:
        message = "Oi! estava no seu site, gostaria de saber mais sobre os serviços/produtos que você oferece!😁";
    }
...
useEffect(() => {
  const telefone = getUrlParameter('telefone') || '556492722036';
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="whatsapp-card max-w-md w-full mx-auto p-6">
          ...
          <div className="mt-6 text-center text-sm text-gray-500 border-t pt-4">
            <p>DV&C - Turismo e Viagens</p>
            <p className="font-semibold mt-1">Transformando sonhos em memórias inesquecíveis</p>
          </div>
        </div>
      </div>
